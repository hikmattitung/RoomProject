...
<body>
      ...
      <div class="swiper mySwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="Images/Slider/1.webp"  class="w-100 d-block img-fluid"/>
          </div>
          <div class="swiper-slide">
          <img src="Images/Slider/3.webp" class="w-100 d-block img-fluid" />
          </div>
          <div class="swiper-slide">
          <img src="Images/Slider/2.webp"  class="w-100 d-block img-fluid"/>
          </div>
          <div class="swiper-slide">
          <img src="Images/Slider/4.webp" class="w-100 d-block img-fluid" />
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="facilities.php" class="btn btn-outline-dark btn-sm rounded-0 fw-bold shadow-none">More Facilities >>></a>
      </div>
    </div>
  </div>
  ...
  <div class="container mt-5">
    <div class="swiper swiper-testimonials">
      ...
      <div class="swiper-slide bg-white p-4">
          ...
          <p>
          They were extremely accommodating and allowed us to check in early at like 10am.
